...
r2.brandActionCode,'\"',',','\"',r2.id_comercio,'\"',',','\"',ifnull(r2.nombre_comercio,''),'\"',',','\"',ifnull(r2.fecha_hora_creacion,''),'\"',',','\"',
...
c.id as id_comercio,c.nombre_comercial as nombre_comercio, a.fecha_hora_creacion,a.exitosa,a.tarhab_email, a.hash_tarjeta,a.monto_autorizado, a.numero_tarjeta_enmascarada ,
